...
import { UpdateAnnouncementMixedInput } from './inputs/update-announcement-characteristic.input';
...
export class AnnouncementCharacteristicResolver {
  ...
  async updateAnnouncementCharacteristic(@Args('data') data: UpdateAnnouncementMixedInput) {
  ...
  async addAnnouncementCharacteristic(@Args('data') data: UpdateAnnouncementMixedInput) {
